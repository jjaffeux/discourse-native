...
class VoiceDiagnosticsView extends StatefulWidget {
  const VoiceDiagnosticsView({
    super.key,
    ...
    this.clipboardByteLimit = voiceDiagnosticsClipboardByteLimit,
  ...
  final VoiceDiagnosticsUiState Function() readState;
  ...
  final Future<VoiceClipboardReport> Function(int byteLimit)?
  buildClipboardReport;
  final VoiceReportWriter? writeJsonReportTo;
  final VoiceReportExporter exporter;
  ...
  @override
  State<VoiceDiagnosticsView> createState() => _VoiceDiagnosticsViewState();
}

class VoiceDiagnosticsUiState {
...
class _VoiceDiagnosticsViewState extends State<VoiceDiagnosticsView> {
  ...
  Widget build(BuildContext context) {
    return ListenableBuilder(
      key: const ValueKey('voice-diagnostics-listener'),
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      return _CaptureEventRow(
                        key: ValueKey('voice-diagnostic-event-${event.id}'),
                        event: event,
  ...
  Future<void> _exportReport() async {
    await _runBusy(() async {
      ...
      final VoiceReportExportOutcome outcome;
      if (exporter is StreamingVoiceReportExporter && writer != null) {
        outcome = await (exporter as StreamingVoiceReportExporter)
...
class _CaptureControls extends StatelessWidget {
  ...
  final VoiceDiagnosticsUiState state;
  final bool busy;
...
class _CaptureEventDetail extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    return ListView(
      key: ValueKey('voice-diagnostic-detail-${event.id}'),
