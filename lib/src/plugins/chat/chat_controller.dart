...
class ChatController extends FrameSafeNotifier {
  ...
  final Map<String, PluginChannelSubscription> _rootSubscriptions = {};
  final Map<String, Set<Object>> _threadViewTokens = {};
  final Map<String, PluginChannelSubscription> _threadSubscriptions = {};
  ...
  final Map<String, PluginChannelHost> _channelHosts = {};
  final Map<String, PluginChannelSubscription> _presenceSubscriptions = {};
  ...
  final Map<String, PluginChannelSubscription> _newMessageSubscriptions = {};
  final Map<String, PluginChannelSubscription> _newMentionSubscriptions = {};
  final Map<String, PluginChannelSubscription> _kickSubscriptions = {};
  final Map<String, int?> _newChannelCursors = {};
  final Map<String, PluginChannelSubscription> _newChannelSubscriptions = {};
  ...
  final Map<String, List<PluginChannelSubscription>>
  ...
  final Map<String, PluginChannelSubscription> _userHasThreadsSubscriptions =
      {};
  ...
  final Map<String, PluginChannelSubscription> _sendSubscriptions = {};
  ...
  void attachChannels(String siteUrl, PluginChannelHost channels) {
  ...
  void _cancelActiveStreamSubscriptions(String siteUrl) {
    final cancelled = <PluginChannelSubscription>[];
  ...
  void _cancelSubscription(
    PluginChannelSubscription? subscription,
    String operation,
  ) {
  ...
  void _syncNewMessageSubscriptions(String siteUrl) {
    ...
    if (currentUserId != null &&
      ...
      final subscriptions = <PluginChannelSubscription>[];
      try {
        subscriptions.add(
  ...
  void _applyKick(String siteUrl, int channelId, Object? data) {
    ...
    final kickedThreadSubscriptions = <PluginChannelSubscription>[];
