...
final class ChatRoute {
  const ChatRoute._({required this.channelId, this.threadId});
  ...
  String get routeId => threadId == null
      ? '$_channelPrefix$channelId'
      : '$_channelPrefix$channelId$_threadMarker$threadId';
  ...
  @override
  int get hashCode => Object.hash(channelId, threadId);
...
final class ChatLink {
  ...
  /// `/chat/c/-/9/44` and `/chat/c/-/9/t/3/44`. Query strings, fragments, and
  /// one trailing slash do not alter that identity.
  ...
  static final RegExp _pathPattern = RegExp(
    r'^/chat/c/-/([1-9][0-9]*)(?:(?:/([1-9][0-9]*))|(?:/t/([1-9][0-9]*)(?:/([1-9][0-9]*))?))?/?$',
  );
