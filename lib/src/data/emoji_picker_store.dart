...
///
/// Web Discourse keeps topic and chat favorites apart. Native does the same so
/// a reader's conversational emoji do not displace the ones they use in posts.
enum EmojiPickerContext { topic, chat }
