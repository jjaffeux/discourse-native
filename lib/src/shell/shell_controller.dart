...
class ShellController extends FrameSafeNotifier {
  ...
  Future<DiscourseUser?> _readSessionUser(
    ...
    // Let an immediately requested account switch establish its signed-out
    // identity boundary first. A background refresh for account A must not be
    // the request observers mistake for account B's post-handshake lookup.
