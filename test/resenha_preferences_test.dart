...
void main() {
  test('replacement device writes persist the latest request', () async {
    ...
    final replacementPreferences = SharedPreferencesResenhaPreferences(
      persistence: persistence,
    );
  ...
  test('a rejected write keeps the existing error contract', () async {
    ...
    final preferences = SharedPreferencesResenhaPreferences(
      persistence: persistence,
    );
...
final class _FailingReadPersistence implements ResenhaPreferencesPersistence {
...
final class _ControlledPersistence implements ResenhaPreferencesPersistence {
