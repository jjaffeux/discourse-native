...
import 'support/resenha_fake_chat_conversations.dart';
...
void main() {
      ...
      testWidgets(
        ...
        (tester) async {
          ...
          final room = _room(
            ...
            videoAllowed: true,
            participants: [
              ResenhaParticipant(id: 1, username: 'sam', role: role),
            ],
          );
    ...
    testWidgets(
      ...
      (tester) async {
        ...
        expect(preferences.deviceWrites, [
          (
            preference: ResenhaDevicePreference.audioInput,
            value: 'microphone-2',
          ),
  ...
  group('editor and dialog lifecycle', () {
    ...
    testWidgets('uses the latest controller when saving a room', (
      ...
      expect(update.path, '/resenha/rooms/7.json');
      expect(
    ...
    testWidgets('uses the latest controller when confirming a flag', (
      ...
      try {
        ...
        expect(flag.path, '/resenha/rooms/7/flag.json');
        expect(flag.body, {
          'user_id': 2,
          'flag_type_id': 3,
    ...
    testWidgets('uses the latest controller when confirming recording', (
      ...
      try {
        ...
        expect(recording.path, '/resenha/rooms/7/recording.json');
