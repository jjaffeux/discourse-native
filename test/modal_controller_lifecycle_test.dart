...
void main() {
  ...
  group('account and update sheets', () {
    testWidgets('an open update sheet follows a replacement controller', (
      ...
      final first = _controller(
        ...
        updateStore: FakeUpdateStore(
          rawChannel: 'canary',
          lastChecked: DateTime.utc(2026, 8, 31),
        ),
      );
  ...
  group('instance actions', () {
    ...
    testWidgets('a removal dialog ignores a replaced controller', (
      tester,
    ) async {
  ...
  group('stale post and reaction operations', () {
