...
final class NativeResenhaDiagnosticsSdkLogBridge
  ...
  static final List<NativeResenhaDiagnosticsSdkLogBridge> _globalOwners = [];
  ...
  @override
  Future<void> install(ResenhaDiagnosticsRecorder recorder) async {
    ...
    final logger = native_logger.Logger(
      ...
      output: _ResenhaWebRtcLogOutput(recorder),
...
@visibleForTesting
Future<void> runResenhaSdkCleanup(
...
final class _ResenhaWebRtcLogOutput extends native_logger.LogOutput {
  _ResenhaWebRtcLogOutput(this.recorder);

  final ResenhaDiagnosticsRecorder recorder;
